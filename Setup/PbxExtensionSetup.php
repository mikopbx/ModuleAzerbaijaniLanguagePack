...
namespace Modules\ModuleAzerbaijaniLanguagePack\Setup;
 ...
 * PbxExtensionSetup
 *
 * Setup class for Azerbaijani Language Pack Module
 *
 * This Language Pack module provides automatic installation of:
 * - Azerbaijani UI translations from Messages/az/ directory
 * - Azerbaijani voice prompts from Sounds/az-az/ directory
 *
 ...
 *
 * @package Modules\ModuleAzerbaijaniLanguagePack\Setup
 */
class PbxExtensionSetup extends PbxExtensionSetupBase
{
     ...
     */
    protected string $moduleUniqueID = 'ModuleAzerbaijaniLanguagePack';

    /**
     * Additional actions before module installation
     *
     * For Language Pack modules, we check for conflicts with other Azerbaijani packs.
    ...
    public function onBeforeModuleEnable(): bool
    {
        ...
        if ($conflictModule !== null) {
            $this->messages[] = "Cannot install: Another Azerbaijani Language Pack ($conflictModule) is already installed. Please uninstall it first.";
            return false;
        }
    ...
    public function onAfterModuleEnable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Azerbaijani Language Pack installed successfully',
            LOG_INFO
        );
    ...
    public function onBeforeModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Uninstalling Azerbaijani Language Pack',
            LOG_INFO
        );
    ...
    public function onAfterModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Azerbaijani Language Pack uninstalled successfully',
            LOG_INFO
        );
