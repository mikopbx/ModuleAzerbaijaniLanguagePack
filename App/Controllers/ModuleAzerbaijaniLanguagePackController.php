...
namespace Modules\ModuleAzerbaijaniLanguagePack\App\Controllers;

use MikoPBX\AdminCabinet\Controllers\BaseController;
use MikoPBX\Modules\PbxExtensionUtils;

/**
 * ModuleAzerbaijaniLanguagePackController
 *
 * Controller for Azerbaijani Language Pack module information page
 */
class ModuleAzerbaijaniLanguagePackController extends BaseController
{
    private string $moduleUniqueID = 'ModuleAzerbaijaniLanguagePack';
    ...
    public function indexAction(): void
    {
        ...
        // Count sound files
        $soundsDir = $this->moduleDir . '/Sounds/az-az';
        $soundFileCount = 0;
        if (is_dir($soundsDir)) {
        ...
        $messagesDir = $this->moduleDir . '/Messages/az';
        ...
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-azerbaijani-language-pack-sounds-api.js", true);
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-azerbaijani-language-pack-progress.js", true);
    ...
    public function soundsAction(): void
    {
        ...
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-azerbaijani-language-pack-sounds-api.js", true);
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-azerbaijani-language-pack-sounds-index.js", true);
