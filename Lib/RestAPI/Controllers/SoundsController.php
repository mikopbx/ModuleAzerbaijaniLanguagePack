...
namespace Modules\ModuleAzerbaijaniLanguagePack\Lib\RestAPI\Controllers;
 ...
 *   GET /pbxcore/api/v3/module-azerbaijani-language-pack/sounds
 *   GET /pbxcore/api/v3/module-azerbaijani-language-pack/sounds/progress
 */
class SoundsController extends ModulesControllerBase
{
    private const string MODULE_UNIQUE_ID = 'ModuleAzerbaijaniLanguagePack';
